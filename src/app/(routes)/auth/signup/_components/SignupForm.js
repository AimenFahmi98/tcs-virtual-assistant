...
export default function SignupForm() {
  ...
  return (
    <>
      <div className="flex min-h-screen items-center justify-center bg-orange-400 px-4">
        <div className="w-full max-w-lg space-y-6 rounded-3xl bg-white p-8 shadow-2xl sm:p-12">
