...
const BtnAppAgent = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="group fixed left-[350px] top-2 z-50 flex items-center gap-3 rounded-xl bg-primary_light px-3 py-1.5 shadow-md backdrop-blur-sm transition-all duration-300 hover:bg-primary"
